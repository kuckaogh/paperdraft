SUBROUTINE SIMPLE_Multigrid(ppOUT,uuOUT,vvOUT,wwOUT,      & !OUT
...
REAL(8)    ,DIMENSION(0:NXm  ,0:NYm+1,0:NZm+1) ,INTENT(IN)    :: uuIN
REAL(8)    ,DIMENSION(0:NXm+1,0:NYm+1,0:NZm  ) ,INTENT(IN)    :: wwIN
REAL(8)    ,DIMENSION(0:NXm+1,0:NYm  ,0:NZm+1) ,INTENT(IN)    :: vvIN
REAL(8)    ,DIMENSION(0:NXm  ,0:NYm+1,0:NZm+1) ,INTENT(OUT)   :: uuOUT
REAL(8)    ,DIMENSION(0:NXm+1,0:NYm+1,0:NZm  ) ,INTENT(OUT)   :: wwOUT
REAL(8)    ,DIMENSION(0:NXm+1,0:NYm  ,0:NZm+1) ,INTENT(OUT)   :: vvOUT
...
ENDSUBROUTINE SIMPLE_Multigrid